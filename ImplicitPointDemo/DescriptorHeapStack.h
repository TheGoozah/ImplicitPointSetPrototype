//Extracted from D3D12RaytracingMiniEngineSample
#pragma once
#include <d3d12.h>
#include "d3dx12.h"  //IID_PPV_ARGS
#include <atlbase.h> //CComPtr & IID_PPV_ARGS
...
public:
		...
		m_device(device)
	{
		...
		m_descriptorSize = device.GetDescriptorHandleIncrementSize(m_descriptorHeapType);
